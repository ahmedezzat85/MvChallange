  ...
  with variable_scope.variable_scope(scope, 'InceptionV2', [inputs]):
    with arg_scope(
      ...
      with variable_scope.variable_scope(end_point):
        ...
        with variable_scope.variable_scope('Branch_3'):
          ...
          branch_3 = layers.conv2d(
              ...
              weights_initializer=trunc_normal(0.1),
              scope='Conv2d_0b_1x1')
        net = array_ops.concat([branch_0, branch_1, branch_2, branch_3], concat_axis)
        end_points[end_point] = net
        if end_point == final_endpoint:
          return net, end_points
      # 28 x 28 x 256
      ...
      with variable_scope.variable_scope(end_point):
        ...
        net = array_ops.concat([branch_0, branch_1, branch_2], concat_axis)
        end_points[end_point] = net
        if end_point == final_endpoint:
          return net, end_points
      # 14 x 14 x 576
  ...
  with variable_scope.variable_scope(
    ...
    with arg_scope(
      ...
      net, end_points = inception_v2_base(
          inputs,
          concat_axis=1 if data_fmt=='NCHW' else 3,
          scope=scope,
          min_depth=min_depth,
          depth_multiplier=depth_multiplier)
      with variable_scope.variable_scope('Logits'):
        if data_fmt == 'NHWC': net = math_ops.reduce_mean(net, [1, 2], keep_dims=True, name='global_pool')
        else: net = math_ops.reduce_mean(net, [2, 3], keep_dims=True, name='global_pool')
        # 1 x 1 x 1024
        ...
        logits = layers.conv2d(
            ...
            normalizer_fn=None,
            scope='Conv2d_1c_1x1')
        logits = layers_lib.flatten(logits, scope='Flatten')
...
def inception_v2_arg_scope(is_training=True, data_format='NHWC'):
  ...
  with arg_scope(
      [layers.conv2d, layers_lib.fully_connected, layers_lib.batch_norm, 
